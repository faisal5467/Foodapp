...
import Transaction from '../admin_tabs/Transaction';
import Add from '../admin_tabs/Add';
import Items from '../admin_tabs/Items';
import Orders from '../admin_tabs/Orders';
import Notification from '../admin_tabs/Notification';
      ...
      <View style={styles.bottomView}>
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            style={[styles.bottomTabImage, {width: 35, height: 35,tintColor:selectedTab==2 ?'red':'black'}]}
          />
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.bottomTab}
